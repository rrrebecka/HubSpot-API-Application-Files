...
<head>
<meta charset="UTF-8">
<title>Obtain Access Token Send Variable</title>
</head>
<body>
...
$_SESSION['hstoken'] = $json["access_token"];
...
if ($err) {
    ...
    echo $_SESSION['hstoken'] ;   
}
    
if(isset($response));
    unset($response); 
  
header('Location: http://localhost:8888/hubspot/hubspot-email-unsubscribe-all.php'); 
